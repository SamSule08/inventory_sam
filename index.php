<?php
	...
	require_once('inc/item_listingTab.php')
?>
  <body>
<?php
	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link active" id="v-pills-search-tab" data-toggle="pill" href="#item_listingTab" role="tab" aria-controls="v-pills-search" aria-selected="True">Item Listings</a>
				  ...
				  <div class="card-body">										
					...
					<div class="tab-content">
						...
						<div id="vendorSearchTab" class="container-fluid tab-pane fade">
							...
							<br>
							<p>Use the grid below to search demand forecast details</p>
							<div class="table-responsive" id=""></div>
						</div>
						<div id="" class="container-fluid tab-pane fade">
					</div>
				  </div> 
				</div>
			  </div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="# ">demand forecast</a>
						</li>
					</ul>
